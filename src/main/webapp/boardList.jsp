...
<body class="subpage">
   <div id="page-wrapper">
      ...
      console.log("|___________|  |            |  ____|   |     |     |  |____        ");
      console.log("_____________  |            |      |   |_____|_____|  |            ");
      console.log("      |        |            |      |       _----------_            ");
      console.log("  _-------_     |          |       |      |            |           ");
            ...
            <div class="row">
               ...
               <div class="col-9 col-12-medium imp-medium">
                  ...
                  <section>
                     <header>
                        <h2>커뮤니티 게시판</h2>
                        <h3>게시글을 작성하여 소통해보세요!</h3>
                        <a href="newBoardPage.do?categoryName=normal">
                  ...
                  <!-- 게시글 전체 출력 및 검색 기능 -->
                     ...
                     <section id="search-section">
                         ...
                         <form action="searchBoards.do" method="get" id="searchForm">
                             <input type="hidden" name="categoryName" value="${boardCateName}">
